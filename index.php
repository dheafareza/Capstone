...
<div class="modal fade" id="modalEditCatatan" tabindex="-1" role="dialog" aria-labelledby="modalEditCatatanLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="catatan/edit_catatan.php" method="GET">
        <div class="modal-body">
          <input type="hidden" name="id_catatan" value="1"> <!-- Ganti value dengan ID dinamis -->
          <div class="form-group">
            <label for="catatan">Catatan</label>
            <textarea class="form-control" id="catatan" name="catatan" rows="3" required>Isi Catatan Lama</textarea>
          </div>
        </div>
