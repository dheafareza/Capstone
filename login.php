...
<body style="background: linear-gradient(90deg,rgb(252, 252, 252) 0%,rgb(169, 172, 188) 100%);">
            ...
            <!-- Nested Row within Card Body -->
                ...
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Sistem Infomasi Keuangan</h1>
                  </div>
                  <form class="user" action="proses-login.php" method="post">
                    ...
                    <div class="form-group">
                      <input type="password" name="pass" class="form-control form-control-user" id="exampleInputPassword" placeholder="Masukan Password">
                    </div>
                    <div class="form-group">
